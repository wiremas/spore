...
from utils import brush_ctrl, window_utils, mesh_utils, node_utils, message_utils
from ui import canvas
from data import brush_state
...
class SporeContext(ompx.MPxContext):
    ...
    def toolOnSetup(self, event):
        ...
        self.ctrl.get_node_state(self.target_node)
    ...
    def mouse_moved(self, position):
        ...
        if not self.state.first_scale:
            ...
            result = mesh_utils.hit_test(self.target_mesh, self.state.first_x, self.state.first_y)

        else:
            result = mesh_utils.hit_test(self.target_mesh, position.x(), position.y())
